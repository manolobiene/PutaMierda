		...
		case Faces.U:
			...
			if (hit.collider != null){
				if (hit.collider.gameObject.GetComponent<Rigidbody2D>()){
					hit.collider.gameObject.GetComponent<Rigidbody2D>().AddForce(Vector3.up*0.3f, ForceMode2D.Impulse);
				}
			}
			break;
		case Faces.D:
			...
			if (hit1.collider != null){
				if (hit1.collider.gameObject.GetComponent<Rigidbody2D>()){
					hit1.collider.gameObject.GetComponent<Rigidbody2D>().AddForce(-Vector3.up*0.3f, ForceMode2D.Impulse);
				}
			}
			break;
		case Faces.L:
			...
			if (hit2.collider != null){
				if (hit2.collider.gameObject.GetComponent<Rigidbody2D>()){
					...
					hit2.collider.gameObject.GetComponent<Rigidbody2D>().AddForce(-Vector3.right*0.3f, ForceMode2D.Impulse);
		...
		case Faces.R:
			...
			if (hit3.collider != null){
				if (hit3.collider.gameObject.GetComponent<Rigidbody2D>()){
					hit3.collider.gameObject.GetComponent<Rigidbody2D>().AddForce(Vector3.right*0.3f, ForceMode2D.Impulse);
				}
			}
			break;
		}
